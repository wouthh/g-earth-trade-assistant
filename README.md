...
java -jar target/g-earth-trade-assistant-0.1.3.jar --demo
```
...
- `target/g-earth-trade-assistant-0.1.3.jar` — executable shaded extension JAR.
- `target/G-Earth-Trade-Assistant-0.1.3-extension.zip` — loadable extension folder with launcher, JAR and notices.
